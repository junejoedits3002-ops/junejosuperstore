...
export const MobileBottomNav: React.FC = () => {
  ...
  const handleWhatsAppFloating = () => {
    const url = `https://wa.me/${storeSettings.whatsappNumber}?text=Assalam%20o%20Alaikum%20Junejo%20Superstore!%20I%20want%20to%20place%20a%20grocery%20order%20in%20Hyderabad...`;
