    ...
    <header className="sticky top-0 z-40 bg-white/85 backdrop-blur-md shadow-xs border-b border-stone-200/70 transition-all">
        ...
        <div className="flex items-center justify-between gap-3 md:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <a
              ...
              href={`https://wa.me/${storeSettings.whatsappNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent('Assalamualaikum JUNEO SUPERSTORE! I would like to inquire about grocery delivery.')}`}
              target="_blank"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-lg border-t border-stone-200/80 px-4 pt-3 pb-6 space-y-3 shadow-xl">
          ...
          <div className="pt-2">
            <a
              href={`https://wa.me/${storeSettings.whatsappNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent('Assalamualaikum JUNEO SUPERSTORE! I want to order groceries.')}`}
              target="_blank"
              rel="noopener noreferrer"
